<?php 
    ...
    $where = "special_external_gcrequest.spexgc_status='approved'
        ...
        AND 
            special_external_gcrequest.spexgc_reviewed=''";
    $join = 'INNER JOIN
            users
        ON
            ...
            <div class="panel with-nav-tabs panel-info">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active" style="font-weight:bold"><a href="#tab1default" data-toggle="tab">Special External GC Details</a></li>
                            ...
                            <div class="row">
                                ...
                                <?php else: ?>
                                    <div class="col-md-5 form-horizontal">                                   
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-6 control-label">AR #:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control input-sm inptxt" readonly="readonly" value="<?php echo $request->spexgc_payment_arnum; ?>">
                                            </div>
                                        </div><!-- end form group -->                                                         
                                        <div class="form-group">                                           
                                    ...
                                    <div class="col-md-7 form-horizontal">
                                        <button class="btn pull-right" type="button"aria-label="Left Align" onclick="scanspecialGC(<?php echo $id; ?>)">
                                                <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Scan GC
                                        </button>                                       
                                        ...
                                        <form action="../ajax.php?action=gcreview" method="POST" id="gcreview">
                                            <input type="hidden" value="<?php echo $id; ?>" id="trid" name="trid">
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label">Remarks:</label>
                                                <div class="col-sm-6">
                                                    <textarea class="form-control input-sm inptxt" name="remarks" id="remarks" autofocus></textarea>
                                                </div>
                                            </div><!-- end form group -->  
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label">Total GC Scanned:</label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control input-sm inptxt" value="0" readonly="readonly" id="scannedgc">
                                                </div>
                                            </div><!-- end form group -->  
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label">Total Denomination:</label>
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control input-sm inptxt" value="0.00" readonly="readonly" id="totdenomsca">
                                                </div>
                                            </div><!-- end form group -->  
                                            <div class="form-group">
                                                <label class="col-sm-6 control-label">Reviewed By:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-offset-8 col-sm-4">
                                                    <button class="btn btn-primary btn-block" id="gcreviewbut"><span class="glyphicon glyphicon-share" aria-hidden="true"></span> Submit</button>
                                                </div>
                                            </div><!-- end form group -->  
                                        </form>
