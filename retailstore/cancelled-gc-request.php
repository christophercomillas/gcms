<?php 
  ...
  require 'header.php';
    ...
    $cancelled = getAllCancelledGCRequestByStore($link,$storeid);
  		...
  		<div class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-12">
                    ...
                    <tbody class="store-request-list">
                      <?php foreach ($cancelled as $key): ?>
                        <tr>
                          ...
                          <td><?php echo getUserFirstnameAndLastnameById($link,$key->csgr_by); ?></td>
                ...
                <?php else: ?>
                <div class="alert alert-info"> Threre is no cancelled budget request yet.</div>
                <?php endif; ?>
              </div>
            </div>
        </div>
