              ...
              <div class="col-sm-12 form-container">
                <form class="form-horizontal" action="../ajax.php?action=adjustGCEntry" id="gcAdjustEntry">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <select class="form form-control input-lg" id="_adj_type" name="adj_type" required>
                        <option value="">- SELECT -</option>                        
                        <option value="ne">Negative Entry</option>
                        <option value="pe">Positive Entry</option>                        
                      </select>
                    </div>
                  </div>
                  <!-- end form-group -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input data-inputmask="'alias': 'numeric', 'groupSeparator': '', 'autoGroup': true, 'digits': 0, 'digitsOptional': false, 'prefix': '', 'placeholder': ''" class="form-control input-lg" id="cbdis" name="gcno" required/>
                    </div>
                  </div>
                  <!-- end form-group -->
                  <!-- begin form-group -->
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control input-lg" name="remarks" required>
                    </div>
                  </div>
                  <!-- end form-group -->
                  <!-- begin form-group -->
