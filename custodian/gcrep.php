<?php
	...
	class GCREP extends FPDF
	{
		...
		function docheader()
		{
			...
			$this->Cell(0, 8, 'Fixed Asset Department', 0, 0, "C");
			$this->Ln(5);
		...
		{
			$this->SetFont("Arial", "", 10);
			$this->Cell(30,	8,'Recieving Type:',0,0,'L');
			$this->Cell(60,	8,ucwords($details->csrr_receivetype),0,0,'L');
			$this->Ln(5);
			$this->Cell(30,	8,'Total No. of GC:',0,0,'L');
			$this->Cell(60,	8,number_format($d->cnt).' pcs',0,0,'L');
			$this->Ln(5);
			$this->Cell(30,	8,'TotalGC Amount:',0,0,'L');
			...
			$this->Ln(8);
			$this->SetFont("Arial", "B", 10);
			$this->Cell(80,	8,ucwords($details->firstname.' '.$details->lastname),0,0,'C');
			$this->Ln(5);
			$this->SetFont("Arial", "", 10);
			...
			$this->Cell(80,	1,'(Signature over Printed name)',0,0,'C');
			$this->Cell(80,	1,'(Signature over Printed name)',0,0,'C');
		}
	}
