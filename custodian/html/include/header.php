...
registerImageKey('filetype', $default_value['filetype']);
registerImageKey('dpi', $default_value['dpi']);
registerImageKey('scale', $default_value['scale']);
registerImageKey('rotation', $default_value['rotation']);
registerImageKey('font_family', $default_value['font_family']);
registerImageKey('font_size', $default_value['font_size']);
registerImageKey('text', '220000546547');
?>
...
<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
    ...
    <div class="configurations" style="border: 1px solid;">
