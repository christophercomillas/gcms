            ...
            <div class="panel with-nav-tabs panel-info">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active" style="font-weight:bold"><a href="#tab1default" data-toggle="tab">Approved Special External GC Request</a></li>
                                    ...
                                    <table class="table" id="storeRequestList">
                                        ...
                                        <tbody>
                                            <?php foreach ($request as $r): ?>
                                                <tr onclick="reviewgc(<?php echo $r->spexgc_id; ?>);">
