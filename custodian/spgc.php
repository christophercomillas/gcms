		...
		<div class="row">
			...
			<?php
				...
				foreach ($gcs as $gc): 
					if($trd==4)
					{
						echo '<div style="margin-bottom:170px;"></div>';
						$trd = 0;
					}
				?>
				<div class="gcbg">		
					<div class="accountname"><?php echo strtoupper($gc->spcus_acctname); ?> GIFT CHECK</div>
					<div class="barcode"><?php echo getBarcode($gc->spexgcemp_barcode); ?></div>
					...
					<div class="customer">
						<?php
							...
							echo ucwords(utf8_decode($gc->spexgcemp_lname).' , '.$gc->spexgcemp_fname.' '.$mid_initial.' '.$gc->spexgcemp_extname); ?>
					</div>
					<div class="amount">
						<?php 
