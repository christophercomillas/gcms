                                    ...
                                    <table class="table" id="storeRequestList">
                                        ...
                                        <tbody>
                                            <?php foreach ($request as $key): ?>
                                                <tr <?php if($key->pgcreq_relstatus!='closed'): ?> 
                                                    onclick="releasePromoGC(<?php echo $key->pgcreq_id; ?>)"
                                                    <?php else: ?>
                                                        class="removestyle"
                                                    <?php endif; ?>
                                                >
                                                    ...
                                                    <td><?php echo ucwords($key->prep); ?></td>
                                                    <td><?php echo ucwords($key->recby); ?></td>
                                                    <td>
                                                        <?php
                                                            echo getField2($link,'reqap_approvedby','approved_request','reqap_trid','reqap_approvedtype',$key->pgcreq_id,'promo gc approved');
                                                        ?>
                                                    </td>
                                                    <td><?php echo ucwords($key->pgcreq_relstatus); ?></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
