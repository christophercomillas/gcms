...
<div class="main fluid">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="box box-bot">
                <div class="box-header">
                    <h4><i class="fa fa-inbox"></i> Store GC Request</h4>
                </div>
                <div class="box-content storereqbox">
                    ...
                    <div class="slate-colorbox blue blue-x bot">
                        ...
                        <div class="slate-colorbox-label">
                            Released GC
                        </div>
                        <span class="badge badge-count blue-b"><?php echo $appReq; ?>
                        </span>
                    </div>
                    <?php 
                        $canReq = countStoreGCRequestCancelled($link,$storeid); ?>
                    <?php echo $canReq >
                     0 ? '<a href="cancelled-gc-request.php">':''; ?>
                    <div class="slate-colorbox gray gray-x">
                        <i class="fa fa-times fa-pad"></i>
                        <div class="slate-colorbox-label">
                            Cancelled Request
                        </div>
                        <span class="badge badge-count black-b"><?php echo $canReq; ?>
                        </span>
                    </div>
                    <?php echo $canReq >
                     0 ? '</a>':''; ?>
        ...
        <div class="col-sm-4">
            <div class="box box-bot">
                <div class="box-header">
                    <h4><i class="fa fa-list-alt"></i> Available GC</h4>
                </div>
                <div class="box-content">
                    <ul class="list-group storeavailgcstatus">
                        ...
                        "> <?php echo getCurrentAvailableGCByStore($link,$storeid,$key->
                        denom_id); ?> </span>
        ...
        <div class="col-sm-4">
            <div class="box box-bot">
                <div class="box-header">
                    <h4><i class="fa fa-inbox"></i> Sold GC</h4>
                </div>
                <div class="box-content">
                    <ul class="list-group storesoldgcstatus">
                        ...
                        <li class="list-group-item">
                        <span class="badge badge-sold" did="<?php echo $key->denom_id; ?>" dst="<?php echo $storeid; ?>
                        "> <?php echo getSoldGCPerStore($link,$storeid,$key->
                        denom_id); ?> </span>
                        ₱ <?php echo number_format($key->
                        denomination,2); ?></li>
                        <?php endforeach ?>
