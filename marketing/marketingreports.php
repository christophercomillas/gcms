            ...
            <div class="col-sm-12 form-container">
              <form class="form-horizontal" id="gcSalesReportMarketing" method="POST" action="../ajax.php?action=gcSalesReportMarketing">
                <div class="form-group">
                  <label class="col-sm-5 control-label label-lg">Retail Store: </label>
                  <div class="col-sm-7">
                    <select name="store" class="form form-control input-lg">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-6 col-sm-6">
                    <button class="btn btn-primary btn-md btn-block" id="mktgenpdf"><i class="fa fa-file-pdf-o pdf-generate"></i>  Generate PDF</button>
                  </div>                 
                </div>
                <div class="form-group">
                  <div class="col-sm-offset-6 col-sm-6">
